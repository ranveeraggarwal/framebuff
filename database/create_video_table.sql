...
( 'The Dark Knight' , '152 ' , '1' , 'Action' , 'Citizens for Batman' , ' View content advisory' , 'When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, the caped crusader must come to terms with one of the greatest psychological tests of his ability to fight injustice.' , ''),
( 'The Godfather: Part II' , '200 ' , '1' , 'Crime' , 'USA' , 'Official site' , 'The early life and career of Vito Corleone in 1920s New York is portrayed while his son, Michael, expands and tightens his grip on his crime syndicate stretching from Lake Tahoe, Nevada to pre-revolution 1958 Cuba.' , 'R'),
( 'Schindlers List' , '195 ' , '1' , 'Biography' , 'Official site' , 'Official Facebook' , 'In Poland during World War II, Oskar Schindler gradually becomes concerned for his Jewish workforce after witnessing their persecution by the Nazis.' , ''),
...
( 'Pulp Fiction' , '154 ' , '1' , 'Crime' , 'Official Facebook' , ' View content advisory' , 'The lives of two mob hit men, a boxer, a gangsters wife, and a pair of diner bandits intertwine in four tales of violence and redemption.' , ''),
